...
$Result = Invoke-WebRequest -uri "https://$($Script:NinjaOneInstance)/oauth/token" -Method POST -Body $AuthBody -ContentType 'application/x-www-form-urlencoded'
...
######## Uploading images to use inline in HTML fields ########
